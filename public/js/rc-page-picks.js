  ...
  const PicksPage = () => {
    ...
    return (
      <div className="flex flex-col min-h-screen bg-white font-sans pb-24">
        ...
        {activeView === "matchups" && (
          <div className="px-4">
            <div className="max-w-5xl mx-auto border border-gray-100 rounded-2xl bg-white shadow-sm p-8 text-center">
              <div className="text-sm font-bold uppercase tracking-widest text-gray-400 mb-2">Bowl Matchups</div>
              <div className="text-lg text-gray-600">Ready when you are. We can build this view next.</div>
            </div>
          </div>
        )}
      </div>
